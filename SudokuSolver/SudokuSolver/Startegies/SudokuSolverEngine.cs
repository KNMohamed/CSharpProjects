...
namespace SudokuSolver.Startegies
{
    class SudokuSolverEngine
    {
        ...
        public bool Solve(int[,] sudokuBoard)
        {
            ...
            string currentState = _sudokuBoardStateManager.GenerateState(sudokuBoard);
            string nextState = _sudokuBoardStateManager.GenerateState(strategies.First().Solve(sudokuBoard));
